...
#        necessary?  Why?
#            It's necessary when you want whatever your code computes to stay
#            in the window. If you don't code this the window will  close
#            right after the code is run.
#
